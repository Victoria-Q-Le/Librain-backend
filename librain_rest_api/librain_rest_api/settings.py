"""
Django settings for librain_rest_api project.
...
SECRET_KEY = 'django-insecure-@291c#nnw%0)yq%*jp+@xu$3m76p8*5tpyv3tsmhiz2mv8qej5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost','librain-backend.herokuapp.com']
...
# Using simple jwt to generate token for login because I didnt want to save anything on my database. Follow the setup in Documentation https://django-rest-framework-simplejwt.readthedocs.io/en/latest/getting_started.html
REST_FRAMEWORK = {
...
ROOT_URLCONF = 'librain_rest_api.urls'
...
WSGI_APPLICATION = 'librain_rest_api.wsgi.application'
